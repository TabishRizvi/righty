        ...
        var pass = _.every(validate,function(el,paramType) {
            ...
            if(paramType!="files") {
                ...
                result = _.every(el,function(fileProp,fileName) {
                    ...
                    if(req.files[fileName]==undefined && !fileProp.optional) {

                        errorMsg =  fileName+" is required";
                        return false;
                    }
                    if(req.files[fileName]!=undefined && ! compareMimeTypes(fileProp.mimetype,req.files[fileName].mimetype)) {
                        errorMsg =  "mime-type of "+fileName+" is incorrect";
                        return false;
                    }

                    if(req.files[fileName]!=undefined && req.files[fileName].size>fileProp.size) {
